...
def create_medika_rantai_app():
    ...
    medika_rantai_app.register_blueprint(medika_rantai_bp, url_prefix='/')

    # Register backoffice blueprints
    from backoffice.routes import backoffice_bp
    medika_rantai_app.register_blueprint(backoffice_bp, url_prefix='/backoffice')
